      ...
      {showResults && (
        ...
        >
          ...
          {true && (
            ...
            className={`
              px-20 py-10 rounded-8 text-label-medium transition-all
              ${isAnalyzingAI
                ? 'bg-black-alpha-8 text-black-alpha-32 cursor-not-allowed'
                : 'bg-heat-100 hover:bg-heat-150 text-white shadow-md hover:shadow-lg'
              }
            `}
          >
            {isAnalyzingAI ? (
