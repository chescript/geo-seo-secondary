...
export type BrandMonitorAction =
  ...
  | { type: "SET_GENERATING_PROMPTS"; payload: boolean }
  ...
  | {
      type: "UPDATE_COMPETITOR_METADATA";
      payload: { index: number; metadata: CompetitorMetadata };
    }
  | { type: "SET_ANALYSIS_PROGRESS"; payload: AnalysisProgressState }
  | {
      type: "UPDATE_ANALYSIS_PROGRESS";
      payload: Partial<AnalysisProgressState>;
    }
  ...
  | {
      ...
      payload: { index: number; tile: AnalysisTile };
    }
  ...
  | {
      type: "TOGGLE_MODAL";
      payload: { modal: "addPrompt" | "addCompetitor"; show: boolean };
    }
...
export function brandMonitorReducer(
  ...
  switch (action.type) {
    ...
    case "SET_GENERATING_PROMPTS":
      return { ...state, generatingPrompts: action.payload };
    ...
    case "ADD_CUSTOM_PROMPT":
      return {
        ...state,
        customPrompts: [...state.customPrompts, action.payload],
      };

    case "REMOVE_DEFAULT_PROMPT":
      return {
        ...state,
        removedDefaultPrompts: [...state.removedDefaultPrompts, action.payload],
      };
    ...
    case "REMOVE_COMPETITOR":
      return {
        ...state,
        identifiedCompetitors: state.identifiedCompetitors.filter(
    ...
    case "SET_NEW_COMPETITOR":
      return {
        ...
        ...(action.payload.name !== undefined && {
          newCompetitorName: action.payload.name,
        }),
        ...(action.payload.url !== undefined && {
          newCompetitorUrl: action.payload.url,
        }),
      };
