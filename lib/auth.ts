...
console.log('🔐 [AUTH CONFIG] Database URL:', process.env.DATABASE_URL ? '✅ Set' : '❌ Missing');
console.log('🔐 [AUTH CONFIG] Auth Secret:', process.env.BETTER_AUTH_SECRET ? '✅ Set' : '❌ Missing');
console.log('🔐 [AUTH CONFIG] Base URL:', process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000');
